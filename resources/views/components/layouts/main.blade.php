...
<head>
    <meta charset="utf-8">
    <title>{{ $title ?? 'Solution Hub' }}</title>
    ...
    <link href="/lib/lightbox/css/lightbox.min.css" rel="styleshe
    et">
        ...
        <div class="row">
            <div class="col-lg-3 bg-secondary d-none d-lg-block">
                <a href=""
                    ...
                    <h1 class="m-0 display-3 text-white">Solution Hub</h1>
                </a>
            </div>
            <div class="col-lg-9">
                <div class="row bg-dark d-none d-lg-flex">
                    <div class="col-lg-7 text-left text-white">
                        <div class="h-100 d-inline-flex align-items-center border-right border-primary py-2 px-3">
                            ...
                            <small>rightsolutionhub@gail.com</small>
                        </div>
                        <div class="h-100 d-inline-flex align-items-center border-right border-primary py-2 px-2">
                            <a href="tel:+998949113133"> 
                                <i class="fa fa-phone-alt text-primary mr-2"></i>
                                <small>+998 94 911 31 33 </small>
                            </a>
                        </div>
                        <div class="h-100 d-inline-flex align-items-center py-2 px-2">
                            <a
                                href="https://www.google.com/maps/place/Right+Solution+Hub/@40.5445175,71.0611761,15z/data=!4m6!3m5!1s0x38bae5343629e7f1:0xe3e1e5b5e19fb17e!8m2!3d40.5445175!4d71.0611761!16s%2Fg%2F11svdnc_cc?entry=ttu">
                                <i class="fa fa-home text-primary mr-2"></i>
                                <small>Farg'ona vil, Uchko'prik tum, Dehqon bozori 9-dokon 2-qavat</small>
                            </a>
                        </div>
                    </div>
